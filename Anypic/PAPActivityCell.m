...
- (void)layoutSubviews {
    ...
    [self.activityImageView setFrame:CGRectMake( [UIScreen mainScreen].bounds.size.width - 55.0f, 8.0f, 50.0f, 50.0f)];
    [self.activityImageButton setFrame:CGRectMake( [UIScreen mainScreen].bounds.size.width - 55.0f, 8.0f, 50.0f, 50.0f)];
...
+ (CGFloat)heightForCellWithName:(NSString *)name contentString:(NSString *)content cellInsetWidth:(CGFloat)cellInset {
    ...
    return 68.0f + fmax(0.0f, multilineHeightAddition);
}
