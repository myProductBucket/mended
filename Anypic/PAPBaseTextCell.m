...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        [self.avatarImageView setBackgroundColor:[UIColor whiteColor]];
...
//        self.avatarImageView.layer.masksToBounds = YES;
        ...
        [self.nameButton setTitleColor:[UIColor grayColor] forState:UIControlStateHighlighted];
        ...
        [self.contentLabel setShadowOffset:CGSizeMake( 0.0f, 0.0f)];
        ...
        [self.timeLabel setShadowOffset:CGSizeMake(0, 0)];
