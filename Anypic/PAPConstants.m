...
NSString *const kPAPActivityMessageKey     = @"conversation";
...
NSString *const kPAPActivityTypeMessage    = @"message";
NSString *const kPAPActivityTypeSale       = @"sale";
...
NSString *const kPAPPhotoDescriptionKey     = @"description";
NSString *const kPAPPhotoTitleKey     = @"title";

NSString *const kPAPPhotoPriceKey           = @"price";

NSString *const kPAPPhotoSizeKey            = @"size";
NSString *const kPAPPhotoIsSoldKey          = @"isSold";
NSString *const kPAPPhotoIsFeaturedKey          = @"isFeatured";
NSString *const kPAPPhotoLowerDescriptionKey     = @"lowerDesc";
NSString *const kPAPPhotoLocationKey           = @"location";
NSString *const kPAPPhotoLocationNameKey = @"locationName";
...
NSString *const kPAPPushPayloadActivityMessageKey   = @"m";
