...
- (void)viewDidLoad {
    ...
    [super viewDidLoad];
    self.navigationItem.title = [photo objectForKey:kPAPPhotoTitleKey];
...
//    self.tableView.backgroundView = texturedBackgroundView;
    ...
    self.headerView.frame = [PAPPhotoDetailsHeaderView rectForViewWithDescription:[photo objectForKey:kPAPPhotoTitleKey]];
