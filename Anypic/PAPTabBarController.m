...
- (void)viewDidLoad {
    ...
    [[self tabBar] setBarTintColor:[UIColor colorWithRed:255.0f/255.0f green:255.0f/255.0f blue:255.0f/255.0f alpha:0.2f]];
    ...
    // To add bottom drop shadow this line should add
...
- (void)setViewControllers:(NSArray *)viewControllers animated:(BOOL)animated {
    ...
    cameraButton.frame = CGRectMake( 123.0f, 0.0f, 74.0f, self.tabBar.bounds.size.height - 14);
