...
//  SoldIt
//
//  Created by Xiao Ming Liu on 24/2/2016.
//
//
...
- (void)mg_addElementOnView:(UIView *)view
{
    ...
    [imageView setImage:[UIImage imageWithData:[[NSUserDefaults standardUserDefaults] objectForKey:MY_PORTRAIT]]];
    ...
    [lblTitle setText:[[PFUser currentUser] objectForKey:kPAPUserDisplayNameKey]];
...
//    [itemsContainer addSubview:btContact];
    ...
    NSDictionary *items = NSDictionaryOfVariableBindings(imageView, lblTitle);
...
//    [itemsContainer addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:[btContact(70)]" options:0 metrics:nil views:items]];
    ...
    [itemsContainer addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|[imageView(90)]-10-[lblTitle(30)]|" options:0 metrics:nil views:items]];
}
